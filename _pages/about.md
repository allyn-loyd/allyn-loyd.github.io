...
---
Hi, I'm Allyn! I'm an Industrial Engineering PhD student at the University of Houston, advised by Dr. Gino Lim in the Systems Optimization and Computing Laboratory (SOCL) and supported by the PEAR NSF research traineeship. Broadly, I'm interested in large-scale logistics problems and optimization under uncertainity. Currently, I'm exploring algorithms for routing truck and drone systems for package delivery, natural distaster relief, survelliance, etc. My background in computer science enables me to develop optimization software that is effecient, scalable, and interpretable. 
